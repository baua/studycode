...
val test8_4 = all_answers(fn a => if a = 0 then NONE else SOME [a]) [1, 2] = SOME[1,2]
...
val test10_3 = check_pat (ConstructorP ("hi",TupleP[Variable "x",ConstructorP
("yo",TupleP[Variable "x",UnitP])])) = false
val test10_1 = check_pat(TupleP [Variable "aa", Variable "aa"]) = false
val test11 = match (Const(1), UnitP) = NONE
val test11_2 = match ((Const 1), (Variable "x")) = SOME [("x", Const 1)]
val test11_3 = match(Constructor("pig", Const 5), ConstructorP ("pig", Variable
"myvar")) = SOME [("myvar", Const 5)]
val test11_4 = match(Constructor("pig", Const 5), ConstructorP ("sheep",
Variable "myvar")) = NONE
